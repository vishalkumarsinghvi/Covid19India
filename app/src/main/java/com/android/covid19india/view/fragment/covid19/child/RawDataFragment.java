...
import com.android.covid19india.adapters.RawAdapter;
import com.android.covid19india.model.Covid19.RawData.RawData;
import com.android.covid19india.model.Covid19.RawData.Raw_data;
import com.android.covid19india.model.Covid19.RawData.RowDataComparator;
  ...
  public void onClick(View view) {
    switch (view.getId()) {
      case R.id.tv_patient_id:
        ...
        Collections.sort(raw_dataArrayList, new RowDataComparator.PIDSorter(isPIDClicked));
        rawAdapter.notifyDataSetChanged();
        break;
      case R.id.tv_patient_age:
        isAgeClicked = !isAgeClicked;
        Collections.sort(raw_dataArrayList, new RowDataComparator.AgeSorter(isAgeClicked));
        rawAdapter.notifyDataSetChanged();
        break;
      case R.id.tv_patient_stage:
        isCurrentClicked = !isCurrentClicked;
        Collections.sort(raw_dataArrayList, new RowDataComparator.CurrentSorter(isCurrentClicked));
        rawAdapter.notifyDataSetChanged();
        break;
      case R.id.tv_patient_city:
        isCityClicked = !isCityClicked;
        Collections.sort(raw_dataArrayList, new RowDataComparator.CitySorter(isCityClicked));
        rawAdapter.notifyDataSetChanged();
        break;
    }
  }
