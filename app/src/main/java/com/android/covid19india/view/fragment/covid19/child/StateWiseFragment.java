...
import com.android.covid19india.adapters.StateWiseAdapter;
import com.android.covid19india.model.Covid19.Data.Data;
import com.android.covid19india.model.Covid19.Data.StateWiseDataComparator;
  ...
  public void onClick(View view) {
    switch (view.getId()) {
      case R.id.tv_state:
        ...
        Collections
            .sort(statewiseArrayList, new StateWiseDataComparator.StateSorter(isStateClicked));
        stateWiseAdapter.notifyDataSetChanged();
        break;
      case R.id.tv_confirmed:
        isConfirmedClicked = !isConfirmedClicked;
        Collections.sort(statewiseArrayList,
            new StateWiseDataComparator.ConfirmedSorter(isConfirmedClicked));
        stateWiseAdapter.notifyDataSetChanged();
        break;
      case R.id.tv_active:
        isActiveClicked = !isActiveClicked;
        Collections
            .sort(statewiseArrayList, new StateWiseDataComparator.ActiveSorter(isActiveClicked));
        stateWiseAdapter.notifyDataSetChanged();
        break;
      case R.id.tv_recovered:
        isRecoveredClicked = !isRecoveredClicked;
        Collections.sort(statewiseArrayList,
            new StateWiseDataComparator.RecoveredSorter(isRecoveredClicked));
        stateWiseAdapter.notifyDataSetChanged();
        break;
      case R.id.tv_deaths:
        isDeathClicked = !isDeathClicked;
        Collections
            .sort(statewiseArrayList, new StateWiseDataComparator.DeathsSorter(isDeathClicked));
        stateWiseAdapter.notifyDataSetChanged();
        break;
    }
  }
